...
public class EmailService {
    ...
    public ResponseEntity<?> sendActivationEmail(EmailDTO emailDTO) {
        Email email = Email.builder()
                ...
                .senderEmail("student2students2021@gmail.com")
    ...
    public ResponseEntity<?> sendCommentingEmail(EmailDTO emailDTO) {
        Email email = Email.builder()
                ...
                .senderEmail("student2students2021@gmail.com")
                .subject(emailDTO.getSubject())
                .content(createEmailCommentContent(emailDTO.getStudentCommenting(), emailDTO.getReceiverFirstName()))
                .dateTime(LocalDateTime.now())
    ...
    private String createEmailCommentContent(String initiator, String receiver) {
        ...
        return "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n" +
                ...
                "                      <span style=\"font-family:Helvetica,Arial,sans-serif;font-weight:700;color:#ffffff;text-decoration:none;vertical-align:top;display:inline-block\">New Comment</span>\n" +
                "                    </td>\n" +
                "                  </tr>\n" +
                "                </tbody></table>\n" +
                "              </a>\n" +
